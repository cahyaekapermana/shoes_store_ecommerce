            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('C_Admin/aksi_tambah_produk') ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Nama Produk</label>
                                    <input type="text" class="form-control" name="f_nama" placeholder="Ketik Disini...">
                                </div>
                                <div class="form-group">
                                ...
                                <a class="btn btn-info" href="<?php echo site_url('c_admin/c_dataproduk') ?>">Kembali</a>
