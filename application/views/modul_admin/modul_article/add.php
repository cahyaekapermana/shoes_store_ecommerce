                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Article</h6>
                        </div>

                        <div class="card-body">
                            <form action="<?php echo site_url('C_Admin/aksi_tambah_article') ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Judul</label>
                                    <input type="text" class="form-control" name="f_judul" placeholder="Ketik Disini...">
                                </div>
                                <div class="form-group">
